...
namespace Table_Cart_V2k20.Models
{
    public class FI_GIISHEAD_IPOS
    {
        ...
        public float? CLEARED_AMOUNT { get; set; }
        ...
        public float? Ser_Tax_Per { get; set; }
        public float? Ser_Tax_Amt { get; set; }
        public string BILL_PAD_NO { get; set; }
        public string Print_Invoice { get; set; }
        public float? Print_Seq_No { get; set; }
        ...
        public float Record_ID_FI_Cashier_IN_OUT_Log { get; set; }
        public DateTime Cashier_Settled_Date { get; set; }
        public DateTime Settle_DT { get; set; }
        public int? Mode_Code_Link { get; set; }
        public decimal? Card_Tip { get; set; }
        public decimal? Cash_Tip { get; set; }
    }
}